...
public class KeywordController {
  ...
  public ResponseEntity<List<KeywordWithTopicDto>> queryTotalKeywords() {
    List<KeywordWithTopicDto> dtoList = keywordService.queryTotalKeywords();
  ...
  public ResponseEntity<Void> createService(
      @Validated @RequestBody KeywordCreateDto keywordCreateDto) throws IOException {
  ...
  public ResponseEntity<Void> updateKeyword(
      ...
      @Validated @RequestBody KeywordUserDto keywordUserDto)
      throws IOException {
  ...
  public ResponseEntity<Void> updateKeywordNumbers(
      @Validated @RequestBody List<KeywordNumberDto> keywordNumberDtoList) throws IOException {
