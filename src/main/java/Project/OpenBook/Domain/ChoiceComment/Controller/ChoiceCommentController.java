...
public class ChoiceCommentController {
  ...
  public ResponseEntity queryQuestionChoices(
  ...
  public ResponseEntity insertChoiceInfo(
      @PathVariable("roundNumber") Integer roundNumber,
      @PathVariable("questionNumber") Integer questionNumber,
  ...
  public ResponseEntity insertChoiceInfo(
      @PathVariable("choiceId") Long choiceId, @Validated @RequestBody ChoiceInfoDto dto)
      throws IOException {
  ...
  public ResponseEntity insertChoiceKeyword(
  ...
  public ResponseEntity deleteChoiceKeyword(
      @PathVariable("choiceId") Long choiceId,
      @Validated @RequestBody ChoiceCommentAddUpdateDto dto) {
