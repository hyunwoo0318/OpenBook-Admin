...
public class RoundController {
  ...
  @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "전체 회차 조회 성공")})
  ...
  @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "특정 회차 조회 성공")})
  ...
  public ResponseEntity<Void> updateRound(
      @PathVariable("number") Integer prevNumber, @Validated @RequestBody RoundDto roundDto) {
