...
public class DescriptionController {
  ...
  public ResponseEntity queryQuestionDescription(
      @PathVariable("roundNumber") Integer roundNumber,
      @PathVariable("questionNumber") Integer questionNumber) {

    DescriptionCommentDto dto =
        descriptionCommentService.queryQuestionDescription(roundNumber, questionNumber);
    return new ResponseEntity(dto, HttpStatus.OK);
  }

  @Operation(summary = "보기 키워드/문장 추가")
  @PostMapping("/descriptions/{id}")
  public ResponseEntity insertDescriptionKeyword(
      @PathVariable("id") Long descriptionId,
  ...
  public ResponseEntity deleteDescriptionKeyword(
      @PathVariable("id") Long descriptionId,
      @Validated @RequestBody DescriptionCommentAddDto descriptionCommentAddDto) {
