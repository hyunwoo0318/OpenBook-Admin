...
public class DescriptionCommentService {
  ...
  public DescriptionCommentDto queryQuestionDescription(
      Integer roundNumber, Integer questionNumber) {
    ExamQuestion examQuestion =
        examQuestionRepository
            .queryExamQuestionWithDescription(roundNumber, questionNumber)
            .orElseThrow(
                () -> {
    ...
    List<DescriptionKeyword> descriptionKeywordList =
        descriptionKeywordRepository.queryDescriptionKeywordsForTopicList(description);
    ...
    for (DescriptionKeyword descriptionKeyword : descriptionKeywordList) {
      ...
      ExamQuestionDescQueryDto dto =
          new ExamQuestionDescQueryDto(
              keyword.getTopic().getChapter().getNumber(),
              keyword.getTopic().getTitle(),
              keyword.getName(),
              keyword.getId());
      dtoList.add(dto);
    }
